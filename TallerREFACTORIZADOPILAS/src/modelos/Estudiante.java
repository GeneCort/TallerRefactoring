...
public class Estudiante{
    ...
    //Aplicando el refactoring de Extract Method, creamos el metodo NotaGeneral
    //Y NotaInicial y Final harán un llamado a esta función
    public double CalcularNotaGeneral(Paralelo p, double nexamen,double ndeberes, double nlecciones, double ntalleres){
        double notaG=0;
    ...
    public double CalcularNotaInicial(Paralelo p, double nexamen,double ndeberes, double nlecciones, double ntalleres){
        return this.CalcularNotaGeneral(p, nexamen, ndeberes, nlecciones, ntalleres);
    }
